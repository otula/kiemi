...
public class Sensor {
	...
	public enum ServiceType {
		...
		@SerializedName(TYPE_FOURDEG)
		fourdeg(TYPE_FOURDEG),
		/** Ruuvi/InfluxDB data service */
		@SerializedName(TYPE_RUUVI)
		ruuvi(TYPE_RUUVI),
		/** Ouman data service */
		@SerializedName(TYPE_OUMAN)
		ouman(TYPE_OUMAN),
		/** Pori Energia data service */
		@SerializedName(TYPE_PORI_ENERGIA)
		porienergia(TYPE_PORI_ENERGIA),
		/** Aranet data service */
		@SerializedName(TYPE_ARANET)
		aranet(TYPE_ARANET),
		 ...
		 * 
		 * @param text
		 * @return type or null if invalid type
		 */
		@JsonCreator
