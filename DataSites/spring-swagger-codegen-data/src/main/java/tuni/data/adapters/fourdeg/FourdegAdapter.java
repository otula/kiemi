 ...
 */
package tuni.data.adapters.fourdeg;
 ...
 */
@Component
public class FourdegAdapter implements Adapter {

	@Override
	public List<Data> getData(Sensor sensor, Date from, Date to, Map<String, String> params) throws InvalidParameterException {
		throw new InvalidParameterException("Type "+ServiceType.fourdeg.name()+" not supported by this service.");
	}
