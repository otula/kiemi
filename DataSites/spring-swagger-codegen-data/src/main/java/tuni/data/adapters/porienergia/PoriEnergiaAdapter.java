 ...
 */
package tuni.data.adapters.porienergia;
 ...
 */
@Component
public class PoriEnergiaAdapter implements Adapter {

	@Override
	public List<Data> getData(Sensor sensor, Date from, Date to, Map<String, String> params) throws InvalidParameterException {
		throw new InvalidParameterException("Type "+ServiceType.porienergia.name()+" not supported by this service.");
	}

	@Override
	public ServiceType getServiceType() {
		return ServiceType.porienergia;
	}
