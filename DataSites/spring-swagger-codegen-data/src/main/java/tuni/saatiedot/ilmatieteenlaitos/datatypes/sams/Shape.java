 ...
 * 
 */
@Root(name = Definitions.XML_ELEMENT_SAMS_SHAPE, strict = false)
public class Shape {
	@Element(name = Definitions.XML_ELEMENT_GML_MULTIPOINT, required = false)
	private MultiPoint _multiPoint = null;
	@Element(name = Definitions.XML_ELEMENT_GML_POINT, required = false)
